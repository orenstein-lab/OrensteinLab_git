...
def move_axis(axis_index, pos, axis=None, wait_time=0, check_stability=True, velocity=50):
...
def corotate_axes(axis_1_index, axis_2_index, angle_1, angle_2, axis_1=None, axis_2=None, check_stability=True, velocity=50):
    if esp_model=='301':
...
def move_esp301(axis_index, pos, axis=None, check_stability=True, velocity=50):
    '''
...
def move_esp300(axis_index, pos, axis=None, check_stability=True, velocity=50):
...
def corotate_axes301(axis_1_index, axis_2_index, angle_1, angle_2, axis_1=None, axis_2=None, check_stability=True, velocity=50):
...
def corotate_axes300(axis_1_index, axis_2_index, angle_1, angle_2, axis_1=None, axis_2=None, check_stability=True, velocity=50):
...
def move_axis_1(pos, axis=None, wait_time=0, check_stability=True, velocity=50):
    return move_axis(1, pos, axis, wait_time, check_stability, velocity)

def move_axis_2(pos, axis=None, wait_time=0, check_stability=True, velocity=50):
...
def corotate_axes12(angle, axes=None, bal_angle=0, check_stability=True, velocity=50):
    if axes==None:
