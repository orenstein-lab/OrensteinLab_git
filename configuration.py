import OrensteinLab_git.control import attocube, lakeshore, newport, opticool, razorbill, zurich
import os
...
'z':{'move':attocube.move_z, 'read':attocube.read_z, 'init':attocube.initialize_attocube, 'close':ctrl.close_attocube, 'move_back':10, 'name':'z (um)'},
...
'axis_1':{'move':newport.rotate_axis_1, 'read':newport.read_axis_1, 'init':newport.initialize_rot_axis_1, 'close':newport.close_rot_axis_1, 'move_back':1, 'name':'Angle 1 (deg)'},

'axis_2':{'move':newport.rotate_axis_2, 'read':newport.read_axis_2, 'init':newport.initialize_rot_axis_2, 'close':newport.close_rot_axis_2, 'move_back':1, 'name':'Angle 2 (deg)'},

'axis_3':{'move':newport.rotate_axis_3, 'read':newport.read_axis_3, 'init':newport.initialize_rot_axis_3, 'close':newport.close_rot_axis_3, 'move_back':1, 'name':'Angle 2 (deg)'},

'delay_stage':{'move':newport.rotate_axis_3, 'read':newport.read_axis_3, 'init':ctrl.initialize_rot_axis_3, 'close':ctrl.close_rot_axis_3, 'move_back':1, 'name':'Delay Stage (mm)'},
