...
def move_delay_stage(pos, index=3, axis=None, wait_time=0, check_stability=True, velocity=50):
    return move_axis(index, pos, axis, wait_time, check_stability, velocity)
