...
def motor_scan(map_dict, mkwargs_read_dict={}, ikwargs_dict={}, mobj_dict={}, iobj_dict={}, vars=[], metadata={}, filename_head=None, filename=None, savefile=True, print_flag=False, plot=True, close_devices=True):
    ...
    for ii in tqdm(range(num_pos)):
        ...
        if flag_ini == 1: #sleep for a while for the first point
            time.sleep(5)
            flag_ini = 0
...
def corotate_scan(start_angle, end_angle, step_size, angle_offset, rate_axis_2=1, mkwargs_read_dict={}, ikwargs_dict={}, mobj_dict={}, iobj_dict={}, vars=[], metadata={}, filename_head=None, filename=None, savefile=True, plot=True, close_devices=True):
    ...
    if type(angle_offset)==type(1.24):
        axis_1, axis_2 = newport.corotate_axes(2, 3, start_angle-move_back_1, start_angle+angle_offset-move_back_2, axis_1=axis_1, axis_2=axis_2)
        mobj_dict['axis_2'] = axis_1
        mobj_dict['axis_3'] = axis_2
        axis_1, axis_2 = newport.corotate_axes(2, 3, start_angle, start_angle+angle_offset, axis_1=axis_1, axis_2=axis_2)
        mobj_dict['axis_2'] = axis_1
        mobj_dict['axis_3'] = axis_2
    else:
        axis_1, axis_2 = newport.corotate_axes(2, 3, start_angle-move_back_1, start_angle+angle_offset[0]-move_back_2, axis_1=axis_1, axis_2=axis_2)
        mobj_dict['axis_2'] = axis_1
        mobj_dict['axis_3'] = axis_2
        axis_1, axis_2 = newport.corotate_axes(2, 3, start_angle, start_angle+angle_offset[0], axis_1=axis_1, axis_2=axis_2)
        mobj_dict['axis_2'] = axis_1
        mobj_dict['axis_3'] = axis_2
...
def corotate_scan23(start_angle, end_angle, step_size, angle_offset, rate_axis_2=1, mkwargs_read_dict={}, ikwargs_dict={}, mobj_dict={}, iobj_dict={}, vars=[], metadata={}, filename_head=None, filename=None, savefile=True, plot=True, close_devices=True):
    '''
    Corotation scan moving axes 2 and 3, typically representing wave plates.
    ...
    instruments_header, iobj_dict = helper.get_instruments_header(ACTIVE_INSTRUMENTS, iobj_dict, ikwargs_dict)
    motors_header_measured = [MOTOR_DICT[m]['name']+str(' measured') for m in ACTIVE_MOTORS] # for tracking measured motor positions
    header = [f'Angle 2 (deg)', 'Angle 3 (deg)']+instruments_header+motors_header_measured
    ...
    # setup plots for displaying
    if plot:
        xlabel = f'Angle 2 (deg)'
        fig, axes, plot_handles_dict, xrange, vdata1d_dict = plotters.setup_1d_plots_append(vars, xlabel)

    # select axis to rotate and setup both that axis and conjugate axis
    axis_1 = mobj_dict['axis_2']
    axis_2 = mobj_dict['axis_3']
    move_axis_1 = MOTOR_DICT['axis_2']['move']
    move_axis_2 = MOTOR_DICT['axis_3']['move']
    read_axis_1 = MOTOR_DICT['axis_2']['read']
    read_axis_2 = MOTOR_DICT['axis_3']['read']
    move_back_1 = MOTOR_DICT['axis_2']['move_back']
    move_back_2 = MOTOR_DICT['axis_3']['move_back']
    ...
    for ii, angle in enumerate(angles_1):
        ...
        angle_1 = angle
        angle_2 = angles_2[ii]
        axis_1, axis_2 = newport.corotate_axes(2, 3, angle, angle_2, axis_1=axis_1, axis_2=axis_2)
        mobj_dict['axis_2'] = axis_1
        mobj_dict['axis_3'] = axis_2
